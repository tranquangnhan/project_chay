            ...
            <div class="row">
				...
				if(!count($_SESSION['cart']))
				{
                    ...
                    <section id="checkout-personal-information-step"
                        ...
                        <div class="content">
                            <h3><?=$lang['empty_cart_content']?></h3>
                            <a style="height: auto;padding-top: 10px;padding-bottom: 10px;"
                                class="continue btn btn-info float-xs-right" name="continue"
                                href="<?php echo ROOT_URL;?>/product"><?=$lang['back_to_shop_btn']?></a>
                        </div>
                    </section>
                    <?php
				}
				...
				?>
                        ...
                        <div class="content">
                            <div class="tab-content">
                                <div class="tab-pane active" id="checkout-guest-form" role="tabpanel">
                                    <form action="" id="customer-form" name="customer-form" class="js-customer-form"
                                        method="post">
                                        <section>
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-3">
                                                    <input class="form-control" name="firstname" id="firstname"
                                                        type="text" value="" placeholder="<?=$lang['firstname']?>"
                                                        required>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" name="lastname" id="lastname"
                                                        type="text" value="" placeholder="<?=$lang['lastname']?>"
                                                        required>
                                                </div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    <input class="form-control" name="phone" id="phone" type="number"
                                                        value="" placeholder="<?=$lang['phone']?>" required>
                                                </div>
                                                <div class="col-md-3 form-control-comment">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-3">
                                                    <input class="form-control" name="address1" id="street" type="text"
                                                        value="" required placeholder="<?=$lang['street']?>">
                                                </div>

                                                <div class="col-md-3">
                                                    <input class="form-control" name="address2" id="housenumber"
                                                        type="text" value="" required
                                                        placeholder="<?=$lang['housenumber']?>">
                                                </div>
                                            </div>
                                            <div class="form-group row ">
                                                <label class="col-md-3 form-control-label required">
                                                ...
                                                <div class="col-md-3">
                                                    <input class="form-control" name="address3" id="city" type="text"
                                                        value="" required placeholder="<?=$lang['city']?>">
                                                </div>

                                                <div class="col-md-3">
                                                    <input class="form-control" name="address4" id="country" type="text"
                                                        value="" required placeholder="<?=$lang['country']?>">
                                                </div>
                                            </div>
                                            <div class="form-group row ">
                                                <label class="col-md-3 form-control-label required">
                                                ...
                                                <div class="col-md-6">
                                                    <input class="form-control" name="postcode" id="postcode"
                                                        type="text" value="" placeholder="<?=$lang['postcode']?>"
                                                        required>
                                                </div>
                                                <div class="col-md-3 form-control-comment">
                                                </div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class="textarea" name="note" id="note" cols="55"
                                                        rows="10"></textarea>
                                                </div>
                                                <div class="col-md-3 form-control-comment">
                                                </div>
                                        ...
                                        <footer class="form-footer clearfix">
                                            ...
                                            <button style="" class="continue btn btn-primary float-xs-right"
                                                name="continue" data-link-action="register-new-customer" id="btn-next"
                                                type="submit" value="1">
                                                <?=$lang['continue']?>
                                            </button>
                                        </footer>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="payment-method">
                                    ...
                                    <label for="klarna" class="method klarna" data-tab="klarna">
                                        <img
                                            src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Klarna_Logo_black.svg/1280px-Klarna_Logo_black.svg.png" />
                                    </label>
                                ...
                                <div class="">
                                    <div id="cod" class="tab-payment" style="display: none">
                                        <button style="" class="continue btn btn-info" id="btn-cod" type="button"
                                            value="1">
                                            Place Order
                                        </button>
                                    </div>
                                    ...
                                    <div id="klarna" class="tab-payment" style="display: none;">
                                        <div id="klarna-payments-container" style="text-align: center;"><img
                                                style="width: 25%" src="" id="klarnaid"><br>Scan for Pay with Klarna or
                                            <a href="" id="klarnaurl">Click Here to Open Payment Popup</a></div>
                                    </div>
                    ...
                    var stripe = Stripe(
                        "pk_test_51Ila2jLKgBvDvyCUiqMdG8nou2Ai9VyQQg6CjUHRNBvVMOdiNelHRXuebkj0hixJTY99WBbbyyb4vWfwRZ2Sdqtv00eMi8FXsV"
                        );
                    ...
                    fetch("../stripecheckout", {
                        ...
                        .then(function(data) {
                            ...
                            card.on("change", function(event) {
                                ...
                                document.querySelector("#card-error").textContent = event.error ? event
                                    .error.message : "";
                            });
